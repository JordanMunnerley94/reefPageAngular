...
var reefPageService = (function () {
    function reefPageService(http) {
        this.http = http;
        this.reefPageUrl = "localhost:8080/reefpage";
    }
    reefPageService.prototype.getData = function () {
        return this.http.get(this.reefPageUrl)
            .toPromise().then(function (res) { return res.json()._embedded; })
    ...
    return reefPageService;
}());
exports.reefPageService = reefPageService;
//# sourceMappingURL=reefpage.service.js.map